                ...
                <div class="row-fluid">
                    <div class="span12" style="min-height: 260px">
                        <ul class="site-stats">
                            ...
                            <!-- <li class="bg_lb span12" style="margin-left: 0"><strong>Direção: <?php echo $usuario->direcoes?></strong></li> -->
...
<div class="span6">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12" style="min-height: 260px">
                        <form id="formSenha" action="<?php echo base_url();?>index.php/sigdoc/alterarSenha" method="post">
