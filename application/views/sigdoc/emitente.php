    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content ">
                ...
                estarão disponíveis na tela de impressão de Protocolo.</div>
...
<div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url(); ?>index.php/sigdoc/cadastrarEmitente" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal" >
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Sigdoc - Cadastrar Dados do Emitente</h3>
  </div>
  <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label for="telefone" class="control-label"><span class="required">Telefone*</span></label>
                        <div class="controls">
                            <input type="text" name="telefone" value=""  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="extensao" class="control-label"><span class="required">Extensao*</span></label>
                        <div class="controls">
                            <input type="text" name="extensao" value=""  />
                        </div>
                    </div>
...
<div class="row-fluid" style="margin-top:0">
  ...
  <span> </br> <?php echo $dados[0]->email.', nº:'.$dados[0]->telefone.', '.$dados[0]->extensao; ?> </span> </br> 
...
<div id="modalAlterar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url(); ?>index.php/sigdoc/editarEmitente" id="formAlterar" enctype="multipart/form-data" method="post" class="form-horizontal" >
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">Sigdoc - Editar Dados do Emitente</h3>
  </div>
  <div class="modal-body">
...
<div id="modalLogo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url(); ?>index.php/sigdoc/editarLogo" id="formLogo" enctype="multipart/form-data" method="post" class="form-horizontal" >
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
