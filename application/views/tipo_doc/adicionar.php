    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formTipoDocumentos" method="post" class="form-horizontal" >
...
<script type="text/javascript">
      $(document).ready(function(){
           ...
           $('#formTipoDocumentos').validate({
            rules : {
                  nome:{ required: true},
                  descrisao:{ required: true},
                  
            },
            messages: {
                  nome :{ required: 'Campo Requerido.'},
                  descrisao:{ required: 'Campo Requerido.'},
            },
