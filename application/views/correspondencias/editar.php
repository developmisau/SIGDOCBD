    ...
    <input type="radio"  id="provinienciaExterna" name="tipo_pro"  title="Externa" value="Externa" <?php echo  set_radio('tipo_pro', 'Externa'); ?> > Externa </label>
          ...
          <!--         <?php foreach ($categorias as $cat) { ?>                                   
                    <option value="<?php echo $cat->id ?>"
                      ...
                      <?php foreach ($categorias as $cat) {
                                     if($cat->id == $result->categorias_id){ $selected = 'selected';}else{$selected = '';}
                    ...
                    <option value="<?php echo $t->id ?>"
                        ...
                        <?php foreach ($tipoDoc as $t) {
                                     if($t->id == $result->tipo_doc_id){ $selected = 'selected';}else{$selected = '';}
                  ...
                  <input style="width: 40.5%" id="sRef" type="text" name="sRef" value="SN-<?php echo $ultimoId +1 ?>" readonly />
                    ...
                    <div class="control-group">
                      <label  class="control-label" > Nº Entrada/Saida(Livro)<span class="required">*</span></label>
                        <div class="controls">
                        <input type="number" name="num_entrada_saida_livro"  value="<?php echo $result->num_entrada_saida_livro; ?>" style="width: 20%;">

                        <input type="date" name="data_entrada_saida_livro" style="width: 19%;"  value="<?php echo $result->data_entrada_saida_livro; ?>" style="width: 20%;">                      
                        </div>
                        </div> 
               ...
               <div class="control-group">
                <label for="codigo" class="control-label">Classificador*</label>
                 <div class="controls">
                 <input style="width: 40.5%;" id="codigoAssunto" type="text" name="codigoAssunto" value="<?php echo $result->classificacao_id; ?>"  />
               <input type="hidden" id="classificacao_id" type="text" name="classificacao_id" value="<?php echo set_value('classificacao_id'); ?>" readonly="true" value="<?php echo $result->classificacao_id; ?>" />
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea style="width: 40.5%;" rows="3" cols="30" name="assunto" id="assunto"><?php echo $result->assunto; ?></textarea>
                        </div>
                    </div> 
                          ...
                          <select name="prioridades" id="prioridades" value="<?php echo set_value('prioridades'); ?>" style="width: 42%;"  >
                            <option selected disabled>Selecione Urgencia</option>
                             <?php foreach ($prioridades as $p) {
                                     if($p->id == $result->prioridades_id){ $selected = 'selected';}else{$selected = '';}
                 ...
                 <div class="control-group">
                        ...
                        <div class="controls">
                            <input placeholder="Campo de anexo" style="width: 40.5%;" id="destinatarios" type="text" name="destinatarios" value="<?php echo $result->destinatario; ?>"  />
                        </div>
                    </div>
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea style="width: 40.5%;" rows="3" cols="30" name="observacao" id="observacao" ><?php echo $result->observacao; ?><?php echo $result->observacao; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="arquivo" type="file" name="userfile" value="<?php echo $result->file;?>"  /> (pdf|png|jpg|jpeg)
                        </div>
                    </div>
