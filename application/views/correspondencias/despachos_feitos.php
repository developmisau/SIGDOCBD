...
<div class="span12" style="margin-left: 0">
        ...
        <div class="widget-content nopadding">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td colspan="5">Nenhum Despacho Efectuado!</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
foreach ($resultsDes as $r) {              
                
 if ($direcoes<>" " and $departamentos==0 and $reparticoes==0) {
  if ($r->direcoes_id==$direcoes and $r->departamentos_id==$departamentos and $r->reparticoes_id==$reparticoes) {
                ...
                echo '<td>';
                  ...
                  if($this->permission->checkPermission($this->session->userdata('permissao'),'detCorrespondencia')){
                        echo '<a href="'.base_url().'index.php/correspondencias/visualizar_meus_despachos/'.$r->idCorres.'"  class="btn tip-top" style="margin-right: 1%" title="Ver mais detalhes"><i class="icon-eye-open"></i></a>'; 
...
if ($r->direcoes_id==$direcoes and $r->departamentos_id==$departamentos and $r->reparticoes_id==$reparticoes) {
                ...
                echo '<td>';
                  ...
                  if($this->permission->checkPermission($this->session->userdata('permissao'),'detCorrespondencia')){
                        echo '<a href="'.base_url().'index.php/correspondencias/visualizar_meus_despachos/'.$r->id.'"  class="btn tip-top" style="margin-right: 1%" title="Ver mais detalhes"><i class="icon-eye-open"></i></a>'; 
